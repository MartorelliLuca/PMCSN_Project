...
class SimulationEngine:
    ...
    _REGISTRY = {
    "inValutazione":            (InValutazioneCodaPrioritaNP, ("name", "serversNumber", "mean", "successProbability")),
    "compilazionePrecompilata": (CompilazionePrecompilata,    ("name", "serversNumber", "mean", "successProbability")),
    "invioDiretto":             (InvioDiretto,                ("name", "mean")),
